...
/**
 * is_left - checks if a node
 * @node: A pointe
 * Return: 1 if is a left child
 */
...
/**
 * is_right - checks if a node
 * @node: A pointer to the node.
 * Return: 1 if is a right child.
 */
...
#if !VERBOSE
/**
 * is_bst_helper - checks if a binary.
 * @tree: A pointer to the root node
 * @largest: Value of largest node.
 *
 * Return: 1 if tree is a valid BST
 */
int is_bst_helper(const binary_tree_t *tree, int *largest)
